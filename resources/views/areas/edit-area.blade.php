        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="max-w-3xl bg-white p-8 rounded-lg shadow-lg">
                    <h2 class="text-3xl font-bold text-gray-800 mb-6">Editar Área</h2>                    
                    <form action="{{ route('area.update', $area->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="abbreviation" id="abbreviation" value="{{$area->abbreviation}}" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out" required>
                        </div>
                        
                        <div class="mb-6">
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Descripción</label>
                            <textarea name="description" id="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out" required>{{$area->description}}</textarea>
                        </div>
                        <div class="mb-6">
                            <label for="active" class="inline-flex items-center">
                                <input type="checkbox" name="active" id="active" class="form-checkbox" {{ $area->active ? 'checked' : '' }}>
