        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="max-w-3xl bg-white p-8 rounded-lg shadow-lg">
                    <h2 class="text-3xl font-bold text-gray-800 mb-6">Crear Nuevo Documento</h2>                    
                            ...
                            <div class="space-y-2">
                                @foreach($giroTypes as $giroType)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="giro_types[]" id="giro_type_{{ $giroType->id }}" value="{{ $giroType->id }}" 
