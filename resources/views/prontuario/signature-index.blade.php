                    ...
                    <table id="prontuario-table" class="min-w-full leading-normal w-full">
                        ...
                        <tbody id="prontuarios-body">
                            ...
                            <tr class="odd:bg-gray-50 even:bg-white">
                                ...
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm text-center">
                                    {{ $prontuario->worker?->group?->area?->description ?? 'N/A' }}
                                ...
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm text-center">
                                    <a href="{{ route('firma.show', [$prontuario->giroType->slug, $prontuario->id, $from]) }}"
                                    class="inline-flex items-center justify-center text-gray-600 hover:text-gray-800"
