        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-2">Generar Nuevo Número Entre Equipos</h2>
                    @if ($errors->has('error'))
                        <script>
                    ...
                    <form id="tramiteForm" action="{{ route('prontuario.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="camposInterno" class="space-y-4 px-3">
                                ...
                                <input type="hidden" id="area" name="area" value="{{ auth()->user()->worker->group->area->id }}">
