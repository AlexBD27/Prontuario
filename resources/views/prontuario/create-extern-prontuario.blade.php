        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-2">Generar Nuevo Número Externo</h2>
                    @if ($errors->has('error'))
                        <script>
                    ...
                    <form id="tramiteForm" action="{{ route('prontuario.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="camposExterno" class="space-y-4 px-3">
                                <div>
                                    <label for="entidad_externa" class="block text-sm font-medium text-gray-700 mb-2">Entidad Externa</label>
                                    <select name="entidad_externa" id="entidad_externa" class="select2-documento w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out">
